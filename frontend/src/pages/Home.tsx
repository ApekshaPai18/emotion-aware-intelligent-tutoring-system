...
const Home: React.FC = () => {
  ...
  const handleExistingUser = async () => {
    ...
    try {
      ...
      const userRes = await axios.get(`${API_BASE_URL}/users/by-username/${existingUsername}`);
  ...
  const handleAdminLogin = async () => {
    ...
    try {
      const userRes = await axios.get(`${API_BASE_URL}/users/by-username/${adminUsername}`);
